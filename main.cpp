...
//  https://sites.google.com/site/airrafer
//
...
int main(int argc, const char * argv[])
{
    ...
    sighter->init();
    sighter->loadFaceDetector("haarcascade_frontalface_alt.xml");
    sighter->loadEyeDetector("haarcascade_eye.xml");
    
    MLClassifier mlc(MLClassifier::SVM);
    mlc.loadPCA("pca.dat");
    mlc.loadModel("svm.dat");
